...
function UserDetailModal({ isOpen = false, onClose, user = null }: UserDetailModalProps) {
    const size = "2xl";
    ...
    return (<Modal isOpen={isOpen} size={size} backdrop="blur" onClose={onClose}>
        <ModalContent>
            {(onClose) => (
                <>
                    ...
                    <ModalBody>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                <span className="text-small font-medium">{createDate}</span>
                            </div>
